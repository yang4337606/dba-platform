...
MESSAGES = {
    'zh': {
        ...
        'awr_parse_warning_nonstandard': '警告: 报告格式非标准，部分数据可能未能解析。请检查报告是否包含标准AWR HTML结构。',
        ...
        'label_host': '主机',
        'label_elapsed': '采集时长',
        'label_snap_prefix': '快照',
        'label_awr_report': 'AWR报告',
        'th_analyst': '分析师',
        ...
        'label_version_impact': '影响',
        'label_version_parameter': '参数',
        'label_version_diagnosis': '诊断',
    ...
    'en': {
        ...
        'awr_parse_warning_nonstandard': 'Warning: Non-standard report format detected. Some data may not have been parsed. Please verify the report contains standard AWR HTML structure.',
        ...
        'label_snap_prefix': 'Snapshot',
        'label_awr_report': 'AWR Report',
        'th_analyst': 'Analyst',
        ...
        'th_event': 'Event',
        'th_waits': 'Waits',
        'th_total_wait_time': 'Total Wait Time',
        'th_wait_class': 'Wait Class',
        'th_section': 'Section',
        ...
        'label_version_impact': 'Impact',
        'label_version_parameter': 'Parameter',
        'label_version_diagnosis': 'Diagnosis',
